...
\begin{aligned}
\hat\mu &= \mathtt{RF}(\pn) \\
\Psi_{\text{RF}}(\pn) &= \frac{1}{n}\sum (\hat\mu(X+1) - \hat\mu(X)) 
\end{aligned}
$$
...
\Psi_{\text{OLS}}(\pn) &= \frac{1}{n}\sum (\hat\mu(X+1) - \hat\mu(X)) 
\end{aligned}
$$

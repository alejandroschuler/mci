...
Presume we observe $(Y,X) \in \reals \times \reals$ data and we're interested in the generalized regression coefficient that we discussed in @exm-estimand-reg-coef:
